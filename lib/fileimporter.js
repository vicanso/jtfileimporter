...
(function() {
  var FileImporter, coffeeScript, events, fs, isProductionMode, path, vm, _,
  ...
  FileImporter = (function(_super) {
    ...
    */
    ...
    FileImporter.prototype._getDependencies = function(file, hasCheckedFiles) {
      var code, componentPath, context, e, err, readFile, requireFiles, result, staticPath,
        _this = this;
      ...
      componentPath = this.options.component;
      if (staticPath) {
      ...
      context.require = function(subFile) {
      ...
      _.each(requireFiles, function(tmpFile) {
        ...
        if (!~_.indexOf(result, tmpFile)) {
          return result.push.apply(result, _this._getDependencies(tmpFile, hasCheckedFiles));
        }
      });
      result.push(file);
